...
DOCS_DIR = os.path.join(ROOT_DIR, "knowledge_base", "documents")
...
def ensure_logo_extracted(pdf_path: str | None = None) -> str:
    """Extract embedded logo PNG from page 1 of the brand PDF if not cached."""
    logo_path = os.path.join(DOCS_DIR, LOGO_FILENAME)
