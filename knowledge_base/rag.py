...
CHROMA_DIR = os.path.join(ROOT_DIR, "knowledge_base", "documents", "chroma_db")
...
DATASET_PATH = os.path.join(ROOT_DIR, "dataset", "beamdata_gtm_professional_dataset.xlsx")

campaign_df = pd.read_excel(DATASET_PATH, sheet_name="Campaign_Performance")
feedback_df = pd.read_excel(DATASET_PATH, sheet_name="Customer_Feedback")
personas_df = pd.read_excel(DATASET_PATH, sheet_name="Personas")

print("Campaign Data:", campaign_df.shape)
print("Feedback Data:", feedback_df.shape)
print("Personas Data:", personas_df.shape)